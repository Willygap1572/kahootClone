...
# kahoot-clone-tqte.onrender.com IS IN THE .env FILE
...
VUE_CLIENT = os.environ.get('VUE_CLIENT')
if VUE_CLIENT:
    CORS_ORIGIN_WHITELIST.append(VUE_CLIENT)
...
# Log in and Log out redirection URLs
